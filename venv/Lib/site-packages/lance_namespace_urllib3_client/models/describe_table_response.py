...
class DescribeTableResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["context", "table", "namespace", "version", "location", "table_uri", "schema", "storage_options", "stats", "metadata", "properties", "managed_versioning", "is_only_declared"]
