...
class RefreshMaterializedViewRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identity", "context", "id", "src_version", "max_rows_per_fragment", "concurrency", "intra_applier_concurrency", "source_task_size", "cluster", "output_limit", "manifest"]
